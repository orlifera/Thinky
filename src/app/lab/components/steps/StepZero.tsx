...
export default function StepZero() {
    return (
        <div id='main-content' className='w-full h-[calc(100dvh-22rem)] flex flex-col items-center justify-center gap-4 p-4'>
            ...
            <p className='text-xl w-[80%] text-center'>Questo è lo spazio dedicato a trasformare in competenze conoscenze ottenute fin&apos;ora.</p>
            <p className='text-xl w-[80%] text-center'>La barra qua sopra indica il progresso dell&apos;attività. Adesso, come tutti gli informatici sanno, sei all&apos;inzio, e quindi al passo 0. Dovrai completare i 4 step per arrivare alla fine dell&apos;attività</p>
